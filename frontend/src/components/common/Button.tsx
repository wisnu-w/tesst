...
export const ShareButton: React.FC<ShareButtonProps> = ({onClick}) => {
    const shareButtonStyles: ICommandBarStyles & IButtonStyles = {
        root: {
          ...
          height: 32,
          borderRadius: 4,
          background: 'radial-gradient(109.81% 107.82% at 100.1% 90.19%, #FF6B6E 33.63%, #ED1D25 70.31%, #B30000 100%)',
        //   position: 'absolute',
        //   right: 20,
          padding: '5px 12px',
          marginRight: '20px'
        ...
        rootHovered: {
          background: 'linear-gradient(135deg, #FF6B6E 0%, #ED1D25 51.04%, #ED1D25 100%)',
        },
        label: {
          fontWeight: 600,
          fontSize: 14,
