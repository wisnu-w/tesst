...
import Azure from "../../assets/ICE.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>ICE Assistant</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Don't hesitate to reach out! I'm ready to respond to your inquiries.</h2>
                            </Stack>
                        ) : (
                            ...
                            <Stack>
                                {appStateContext?.state.isCosmosDBAvailable?.status !== CosmosDBStatus.NotConfigured && <CommandBarButton
                                    ...
                                    styles={{ 
                                        ...
                                        root: {
                                            color: '#FFFFFF',
                                            background: "radial-gradient(109.81% 107.82% at 100.1% 90.19%, #FF6B6E 0%, #ED1D25 51.04%, #ED1D25 100%)"
                                        },
                                        rootDisabled: {
                                            background: "#BDBDBD"
                                        }
                                ...
                                <CommandBarButton
                                    ...
                                    styles={{ 
                                        ...
                                        root: {
                                            color: '#FFFFFF',
                                            background: disabledButton() ? "#BDBDBD" : "radial-gradient(109.81% 107.82% at 100.1% 90.19%, #FF6B6E 0%, #ED1D25 51.04%, #ED1D25 100%)",
