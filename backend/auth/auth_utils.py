def get_authenticated_user_details(request_headers):
    ...
    user_object['auth_token'] = raw_user_object.get('X-MS-TOKEN-GOOGLE-ID-TOKEN', None)
    user_object['client_principal_b64'] = raw_user_object['X-Ms-Client-Principal']
    user_object['aad_id_token'] = raw_user_object.get('X-MS-TOKEN-GOOGLE-ID-TOKEN', None)
